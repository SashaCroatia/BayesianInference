...
The data is from USDMDataAvg.csv found from <https://datadryad.org/stash/dataset/doi>[:10.5061/dryad.g1jwstqw7](https://datadryad.org/stash/dataset/doi:10.5061/dryad.g1jwstqw7) . The response variable is an ordinal measure of the severity of drought in the United States called the US Drought Monitor (USDM). The USDM levels are:
...
For demonstration, we only focus on drought levels in Arizona since the beginning of 2020, reflected in the subset datafile USDMData_AZ.csv.
...
Our final data consists of discretized spatial support defined by grid cells of size 0.5 degrees latitude by 0.5 degrees longitude. At each cell is an ordinal measure of drought $Y_{i,t}$ with six possible levels with $i=1,\ldots,125$ areal spatial units and $t=1,\ldots,117$ weeks. Below is an example of what this looks like at $t=1$:
